...
public class Exercise3 {
	...
	public static void main(String[] args) {
		...
		// 5.
		// pi = 22/7;
		// INVALID Output: The variable pi can't be reassigned because it is a constant declared with the final keyword.
		
		// 6.
		// z = name / g;
		// System.out.println(z)
		// INVALID Output: The operator / won't work because name is a string and g is an integer.
		...
		// y = (name + 10)/(name + h);
		// System.out.println(y);
		// INVALID Output: The operator / doesn't calculate strings and name is a string. The + operator can only be used to concatenate strings.
		
		// 11.
		// x = (a + b)/(d + c);
		// System.out.println(y);
		// INVALID Output: The operator + can't be used to a boolean and a double. A double and a long also can't be added.
		...
		// INVALID Output: d is a boolean therefore it cannot be subtracted from c, and c is a negative double.
	}
